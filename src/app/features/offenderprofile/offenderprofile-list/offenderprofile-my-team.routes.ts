...
import { OffenderProfileMyTeamComponent } from '../offenderprofile-list/offenderprofile-my-team.component';
...
export const OFFENDERPROFILE_MY_TEAM_ROUTES: Routes = [
   { path : "", component: OffenderProfileMyTeamComponent, pathMatch: 'full', data:{action:'Read'}},
