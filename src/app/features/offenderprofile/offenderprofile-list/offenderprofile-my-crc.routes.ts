...
import { OffenderProfileMyCRCComponent } from '../offenderprofile-list/offenderprofile-my-crc.component';
...
export const OFFENDERPROFILE_MY_CRC_ROUTES: Routes = [
   { path : "", component: OffenderProfileMyCRCComponent, pathMatch: 'full', data:{action:'Read'}},
