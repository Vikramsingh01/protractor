...
export class RegistrationReviewService {
    ...
    getRegistrationReviewList(): Observable<RegistrationReview[]> {
    ...
    getRegistrationReview(id: number): Observable<RegistrationReview> {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
    ...
    updateRegistrationReview(id: number, registrationReview: RegistrationReview) {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
    ...
    addRegistrationReview(registrationReview: RegistrationReview) {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
        return this.http.post(this.baseUrl, registrationReview, { headers: headers }).map((response: Response) => response.json());
    }

    deleteRegistrationReview(registrationReviewId: number) {
        const headers = new Headers();
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
        return this.http.delete(this.baseUrl + "/" + registrationReviewId, { headers: headers, body: "" });
    }
...
isAuthorize(profileId: number,action:string): Observable<RegistrationReview> {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
       // return this.http.get("http://localhost:4103/addressassesment" + "/authorize/" + profileId + "/" + action ,{ headers: headers, body: "" }).map((response: Response) => {
    ...
    getderegistrationByRegistrationId(id: number): Observable<RegistrationReview> {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
        return this.http.get(this.baseUrl + "/disablereview/" + id, { headers: headers, body: "" }).map((response: Response) => response.json());
    }
}
