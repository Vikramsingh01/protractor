...
export class DeregistrationService {
    ...
    private deregistrationList: Deregistration[] = [];
    private baseUrl: string = ServerUrl(ServiceUrlConstants.CMS) + ServiceUrlConstants.DEREGISTRATION;

    constructor(private http: Http, private tokenService: TokenService, private dataService: DataService) {

    }

    getderegistrationList(): Observable<Deregistration[]> {
    ...
    getderegistration(id: number): Observable<Deregistration> {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
    ...
    updatederegistration(id: number, deregistration: Deregistration) {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
        return this.http.patch(this.baseUrl + "/" + id, deregistration, { headers: headers });
    }
    ...
    addderegistration(deregistration: Deregistration) {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
        return this.http.post(this.baseUrl, deregistration, { headers: headers }).map((response: Response) => response.json());
    }

    deletederegistration(deregistrationId: number) {
        const headers = new Headers();
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
        return this.http.delete(this.baseUrl + "/" + deregistrationId, { headers: headers, body: "" });
    }
