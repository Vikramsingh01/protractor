                        ...
                        if (this.contact.profileId == undefined) {
                            this.contactService.getProfileIdForContact(this.contactId).subscribe((data: any) => {
                                ...
                                this.contactService.getRelatedToList(this.contact.profileId).subscribe(data => {
                                    ...
                                    if (data.locked == "false") {
                                        ...
                                        this.team = data.team;
                                            data.contactOfficer = this.parseOfficer(data.contactOfficer.split("(")[0]);
                            ...
                            this.contactService.getRelatedToList(this.contact.profileId).subscribe(data => {
                                ...
                                this.contactService.getContact(this.contactId).subscribe((data: any) => {
                                    ...
                                    this.listService.getDependentAnswers(104, this.contactAddForm.controls['contactTypeId'].value).subscribe(data =>{
                                    ...
                                    //     this.contactAddForm.patchValue(data);
                                    // });
                                        var relatesToKey=Utility.getObjectFromArrayByKeyAndSubKeyAndValue(this.relateto,"key","description",data.relatesTo);
                                       if(relatesToKey!=null){
                                        data.relatesTo=JSON.stringify(relatesToKey["key"]);
                                       }
    ...
    onSubmit() {
        ...
        if (this.contactAddForm.valid) {
            if (this.contactAddForm.value.location == [""])
                ...
                let contactTypeId = this.contactAddForm.getRawValue().contactTypeId;
                ...
                this.contactAddForm.value.relatesTo = this.relatesTo;
                this.contactAddForm.value.contactTypeId = contactTypeId;

            this.contactService.updateContact(this.contactId, this.contactAddForm.value).subscribe((response: any) => {
