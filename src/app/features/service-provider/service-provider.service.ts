...
export class ServiceProviderService {
    ...
    private serviceProviderList: ServiceProvider[] = [];
    private baseUrl: string = ServerUrl(ServiceUrlConstants.CMS) + ServiceUrlConstants.SERVICEPROVIDER;

    constructor(private http: Http, private tokenService: TokenService, private dataService: DataService) {

    }

    getServiceProviderList(): Observable<ServiceProvider[]> {
    ...
    updateServiceProvider(id: number, serviceProvider: ServiceProvider) {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
        return this.http.patch(this.baseUrl + "/" + id, serviceProvider, { headers: headers });
    }
    ...
    addServiceProvider(serviceProvider: ServiceProvider) {
        ...
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
        return this.http.post(this.baseUrl, serviceProvider, { headers: headers }).map((response: Response) => response.json());
    }
    ...
    deleteServiceProvider(serviceProviderId: number) {
        ...
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
        return this.http.delete(this.baseUrl + "/" + serviceProviderId, { headers: headers, body: "" });
    }
