...
@Injectable()
export class UpwDetailService {

    private upwDetailList: UpwDetail[] = [];
    private baseUrl: string = ServerUrl(ServiceUrlConstants.CMS) + ServiceUrlConstants.UpwDetail;

    constructor(private http: Http, private tokenService: TokenService, private dataService: DataService) {

    }

    getUpwDetailList(): Observable<UpwDetail[]> {
    ...
    getUpwDetail(id: number): Observable<UpwDetail> {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
    ...
    updateUpwDetail(id: number, upwDetail: UpwDetail) {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
        return this.http.patch(this.baseUrl + "/" + id, upwDetail, { headers: headers });
    }
    ...
    addUpwDetail(upwDetail: UpwDetail) {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
        return this.http.post(this.baseUrl, upwDetail, { headers: headers }).map((response: Response) => response.json());
    }

    deleteUpwDetail(upwDetailId: number) {
        const headers = new Headers();
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
        return this.http.delete(this.baseUrl + "/" + upwDetailId, { headers: headers, body: "" });
    }
