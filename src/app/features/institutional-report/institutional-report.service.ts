...
export class InstitutionalReportService {
    ...
    private institutionalReportList: InstitutionalReport[] = [];
    private baseUrl: string = ServerUrl(ServiceUrlConstants.CMS) + ServiceUrlConstants.institutionalReport;

    constructor(private http: Http, private tokenService: TokenService, private dataService: DataService) {

    }

    getInstitutionalReportList(): Observable<InstitutionalReport[]> {
    ...
    getInstitutionalReport(id: number): Observable<InstitutionalReport> {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
    ...
    updateInstitutionalReport(id: number, institutionalReport: InstitutionalReport) {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
        return this.http.patch(this.baseUrl + "/" + id, institutionalReport, { headers: headers });
    }

    sortFilterAndPaginatedrs(filterObj, paginationObj, sortObj) {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
        ...
        return this.http.post(this.baseUrl + "/searchdrs", filterObj, options).map((response: Response) => response.json());
    }
...
sortFilterAndPaginate(filterObj, paginationObj, sortObj) {
    ...
    addInstitutionalReport(institutionalReport: InstitutionalReport) {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
        return this.http.post(this.baseUrl, institutionalReport, { headers: headers }).map((response: Response) => response.json());
    }

    deleteInstitutionalReport(institutionalReportId: number) {
        const headers = new Headers();
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
        return this.http.delete(this.baseUrl + "/" + institutionalReportId, { headers: headers, body: "" });
    }
   ...
   isAuthorize(profileId: number,action:string): Observable<InstitutionalReport> {
        const headers = new Headers();
        headers.append('Accept', 'application/json');
        headers.append('Content-Type', 'application/json');
        headers.append("X-Authorization", this.tokenService.getToken());
